  ...
  useEffect(() => {
    ...
    try {
      ...
      if (enableVoiceControl) {
        initMicrophone().then(ok => { micReady = ok; });
      }
      ...
      const update = (t) => {
        ...
        if (enableVoiceControl && micReady) {
          ...
          const spd = baseRotSpeed + voiceLevel * maxRotationSpeed * 2.0;
          if (voiceLevel > 0.05) currentRot += dt * spd;
          ...
          // Slow idle rotation even without voice
          currentRot += dt * baseRotSpeed;
