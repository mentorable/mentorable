...
import MindPage from "./MindPage.jsx";
...
const SIDEBAR_ROUTES = ["/scorecard", "/chat", "/profile", "/research", "/quest", "/mind"];
...
function MindRoute() {
  const navigate = useNavigate();
  return <MindPage navigate={navigate} />;
}
  ...
  return (
    <AppShell>
      <Routes>
        ...
        <Route path="/mind" element={<MindRoute />} />
