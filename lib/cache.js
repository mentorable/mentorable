...
// Cached user ID — set after first successful auth check so useState initialisers
// can resolve cache keys synchronously, before any async auth call completes.
let _userId = null;
export const getKnownUserId = () => _userId;
export const setKnownUserId = (id) => { _userId = id; };
