...
export function buildSystemPrompt(profile, roadmap) {
  ...
  if (roadmap) {
    ...
    const isCareer = roadmap.mode === "career";
    roadmapSection = `
## Their Career Roadmap
Mode: ${isCareer ? "Career Mode" : "Discovery Mode"}
${isCareer && roadmap.career_direction ? `Chosen career direction: ${roadmap.career_direction}` : ""}Career goal: ${roadmap.career_title}
