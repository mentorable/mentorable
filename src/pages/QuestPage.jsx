  ...
  return (
    <div style={{
      ...
      <div style={{
        flex: 1, display: "flex",
        overflow: "hidden",
        borderTop: `1.5px solid rgba(196,191,184,0.55)`,
      }}>
        {COLUMNS.map((col, idx) => {
          ...
          return (
            <div
              ...
              style={{
                ...
                display: "flex",
                flexDirection: "column",
                borderRight: isLast ? "none" : `1.5px solid rgba(196,191,184,0.55)`,
            ...
            >
              ...
              <div style={{
                ...
                borderBottom: isOver ? `1.5px solid ${col.border}` : "1.5px solid transparent",
