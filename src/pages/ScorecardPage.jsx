      ...
      <style>{`
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .sc-cloud {
          ...
          background: rgba(${theme.rgb},0.14); border: 2px solid #141413; border-radius: 20px;
          padding: 12px 18px 10px;
          animation: sc-float 4.5s ease-in-out infinite;
        }
        .sc-cloud::before, .sc-cloud::after {
          content: ""; position: absolute; background: rgba(${theme.rgb},0.14); border: 2px solid #141413; border-radius: 50%; z-index: 0;
        }
