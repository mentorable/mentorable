      ...
      <style>{`
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .sc-cloud {
          ...
          background: color-mix(in srgb, ${theme.accent} 65%, white); border: 2px solid #141413; border-radius: 20px;
          padding: 12px 18px 10px;
          animation: sc-float 4.5s ease-in-out infinite;
        }
        .sc-cloud::before, .sc-cloud::after {
          content: ""; position: absolute; background: color-mix(in srgb, ${theme.accent} 65%, white); border: 2px solid #141413; border-radius: 50%; z-index: 0;
        }
