...
const FEATURE_COPY = {
  ...
  research: { title: "You've used all 2 research queries", body: "You've reached the research limit for the Mentorable demo. Join the waitlist to get full access when we launch." },
